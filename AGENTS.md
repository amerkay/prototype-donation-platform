...
Use these two sections (project summary and continuous learning) as bounded memory maintained by `$update-project-summary`.
...
17. **KEEP PROJECT SUMMARY CURRENT**: After completing a task that adds, removes, renames, or restructures features, stores, composables, pages, or layouts, you MUST ask: "Did I change project structure?" and "Did I learn a crucial, reusable lesson that prevents future mistakes?". Only if either answer is YES, run `$update-project-summary` to update AGENTS.md.
...
- update-project-summary: Conditional updater. Run only when structure changed or a crucial reusable learning must be preserved; applies bounded AGENTS.md edits. (file: `/home/kay/devel/wildamer-repos/prototype-donation-platform/.codex/skills/update-project-summary/SKILL.md`)
